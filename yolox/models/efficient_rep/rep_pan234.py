...
from yolox.models.efficient_rep.rep_block import RepBlock, SimConv, Transpose
from yolox.models.efficient_rep.rep_backbone import EfficientRep


class RepPANNeck234(nn.Module):
    """RepPANNeck Module
    ...
    def __init__(
        ...
        self.backbone = EfficientRep(channels_list=channels_list, num_repeats=num_repeats)
    ...
    def forward(self, input):
        # TODO: 修改 backbone, 返回 C2 C3 C4 C5
