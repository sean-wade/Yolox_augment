...
class Exp(MyExp):
    ...
    def get_data_loader(self, batch_size, is_distributed, no_aug=False, cache_img=True):
        ...
        with wait_for_the_master(local_rank):
            dataset = SGTLS_Detection(
                json_path="/home/jovyan/tl_infos/total_train_infos.json",
                dataset_name="SGTLS_train_10631",
    ...
    def get_eval_loader(self, batch_size, is_distributed, testdev=False, legacy=False):
        ...
        valdataset = SGTLS_Detection(
            json_path="/home/jovyan/tl_infos/total_val_infos.json",
                dataset_name="SGTLS_val_2796",
