...
def make_parser():
    ...
    parser.add_argument(
        "-f",
        "--exp_file",
        default="/home/zhanghao/code/master/2_DET2D/YOLOX/exps/dtld/dtld_s_attr.py",
        type=str,
        help="please input your experiment description file",
    )
    parser.add_argument("-c", "--ckpt", default="/home/zhanghao/code/master/2_DET2D/YOLOX/YOLOX_outputs/e1_dtld_s_attr/latest_ckpt.pth", type=str, help="ckpt for eval")
    parser.add_argument(
        "--device",
        default="gpu",
        type=str,
